package net.ganixedda.jhipsterionictest.web.rest;

import net.ganixedda.jhipsterionictest.JhipsterIonicTestApp;
import net.ganixedda.jhipsterionictest.domain.Authority;
import net.ganixedda.jhipsterionictest.domain.PersistentToken;
import net.ganixedda.jhipsterionictest.domain.User;
import net.ganixedda.jhipsterionictest.repository.AuthorityRepository;
import net.ganixedda.jhipsterionictest.repository.PersistentTokenRepository;
import net.ganixedda.jhipsterionictest.repository.UserRepository;
import net.ganixedda.jhipsterionictest.security.AuthoritiesConstants;
import net.ganixedda.jhipsterionictest.service.MailService;
import net.ganixedda.jhipsterionictest.service.UserService;
import net.ganixedda.jhipsterionictest.service.dto.UserDTO;
import net.ganixedda.jhipsterionictest.web.rest.vm.KeyAndPasswordVM;
import net.ganixedda.jhipsterionictest.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = JhipsterIonicTestApp.class)
