package net.ganixedda.jhipsterionictest.config.social;

import net.ganixedda.jhipsterionictest.repository.SocialUserConnectionRepository;
import net.ganixedda.jhipsterionictest.repository.CustomSocialUsersConnectionRepository;
import net.ganixedda.jhipsterionictest.security.social.CustomSignInAdapter;
