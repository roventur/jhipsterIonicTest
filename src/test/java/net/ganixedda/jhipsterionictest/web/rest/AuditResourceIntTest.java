...
import net.ganixedda.jhipsterionictest.config.audit.AuditEventConverter;
import net.ganixedda.jhipsterionictest.domain.PersistentAuditEvent;
import net.ganixedda.jhipsterionictest.repository.PersistenceAuditEventRepository;
import net.ganixedda.jhipsterionictest.service.AuditEventService;
